...
ALTER TABLE `cobros` MODIFY COLUMN `idcobro` INTEGER UNSIGNED NOT NULL DEFAULT NULL AUTO_INCREMENT;

ALTER TABLE `pagosprovfc` MODIFY COLUMN `idpago` INTEGER UNSIGNED NOT NULL DEFAULT NULL AUTO_INCREMENT;
