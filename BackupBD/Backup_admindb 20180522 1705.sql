...
INSERT INTO `iconos` (`idicono`,`nombre`,`archivo`,`tooltip`,`teclafn`) VALUES 
 ...
 (11,'importar','importar.png','Importar desde archivo',''),
 ...
 (18,'materiales','materiales.png','Materiales',''),
 (19,'ot','ot.png','OT',''),
 (20,'finalizar','finalizar.png','Finalizar','');
...
INSERT INTO `varpublicas` (`variable`,`tipo`,`valor`,`detalle`,`grupo`,`eliminar`) VALUES 
 ...
 ('_SYSPATHARCHIVOS','C','C:\\GitHub\\ProyectoProcessar\\Archivos\\','Ubicación de los archivos compartidos para todos los usuarios','','N'),
