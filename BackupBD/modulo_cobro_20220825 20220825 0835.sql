...
INSERT INTO `cbasociadas` (`idcbasoci`,`empresaid`,`nombre`,`cuit`,`activa`,`cobra`,`cobropar`,`narchivoe`,`narchivor`,`esecuencia`,`ftp`,`email`,`elong`,`eempresaid`,`eesecuencia`,`eperiodo`,`ebc`,`ebceid`,`ebcsid`,`ebcidcomp`,`etotal1`,`evence1`,`etotal2`,`evence2`,`etotal3`,`evence3`,`eentidad`,`eservicio`,`ecuenta`,`edescrip`,`edescripen`,`r0empresaid`,`r0puntorec`,`r0secuencia`,`r1idcobro`,`r1fechacobro`,`r1importe`,`r1recargo`,`r1bc`,`r2cantidad`,`r2total`,`subcodid`) VALUES 
 (1,'0001','Krumbein','30-71204634-8','S','S','S','0001','0001',2,'','','1-213','1-4','5-5','10-14','24-23','24-4','28-4','32-15','47-12','59-7','66-12','78-7','85-12','97-7','104-6','110-2','112-2','114-50','164-50','2-4','6-13','19-5','2-8','10-7','17-12','29-10','39-80','2-6','8-16','0002'),
 ...
 (3,'0003','Empresa3','20555667778','S','S','N','0003','0003',0,'','','1-213','1-4','5-5','10-14','24-23','24-4','28-4','32-15','47-12','59-7','66-12','78-7','85-12','97-7','104-6','110-2','112-2','114-50','164-50','2-4','6-13','19-5','2-8','10-7','17-12','29-10','39-23','2-6','8-16','0003');
...
INSERT INTO `cbcobrador` (`idcbcobra`,`empresaid`,`nombre`,`cuit`,`activa`,`cobra`,`cobropar`,`narchivoe`,`narchivor`,`esecuencia`,`ftp`,`email`,`elong`,`eempresaid`,`eesecuencia`,`eperiodo`,`ebc`,`ebceid`,`ebcsid`,`ebcidcomp`,`etotal1`,`evence1`,`etotal2`,`evence2`,`etotal3`,`evence3`,`eentidad`,`eservicio`,`ecuenta`,`edescrip`,`edescripen`,`r0empresaid`,`r0puntorec`,`r0secuencia`,`r1idcobro`,`r1fechacobro`,`r1importe`,`r1recargo`,`r1bc`,`r2cantidad`,`r2total`,`subcodid`) VALUES 
 (1,'2011222333401','Cobrador1','20-11222333-4','S','S','S','0001','0001',10,'','ventas@amoblark.com.ar','1-213','1-4','5-5','10-14','24-23','24-4','28-4','32-15','47-12','59-7','66-12','78-7','85-12','97-7','104-6','110-2','112-2','114-50','164-50','2-4','6-13','19-5','2-8','10-7','17-12','29-10','39-23','2-6','8-16','0001'),
 (2,'2022333444501','Cobrador2','20-22333444-5','S','S','N','0001','0002',0,'','','1-213','1-4','5-5','10-14','24-23','24-4','28-4','32-15','47-12','59-7','66-12','78-7','85-12','97-7','104-6','110-2','112-2','114-50','164-50','2-4','6-13','19-5','2-8','10-7','17-12','29-10','39-23','2-6','8-16','0001'),
 (3,'2033444555601','Cobrador3','20334445556','S','S','N','0001','0003',0,'','correo@correo.com','1-213','1-4','5-5','10-14','24-23','24-4','28-4','32-15','47-12','59-7','66-12','78-7','85-12','97-7','104-6','110-2','112-2','114-50','164-50','2-4','6-13','19-5','2-8','10-7','17-12','29-10','39-23','2-6','8-16','0001');
...
INSERT INTO `cbcobrados` (`idcbcob`,`idfactura`,`idcbcobra`,`idcobro`,`secuencia`,`fechacobro`,`impcobro`,`imprecargo`,`bc`,`loteimp`,`timestamp`) VALUES 
 ...
 (5,340,18,7,3,'20220423',3887.22,947.92,'00010001000000000034000',2,'2022-04-27 20:54:16'),
 (6,341,19,7,3,'20220423',283.93,0.00,'00010001000000000034102',2,'2022-04-27 20:54:16'),
 (7,347,21,7,5,'20220430',2200.00,0.00,'00010001000000000034701',3,'2022-04-30 11:56:31'),
 (8,345,22,7,5,'20220430',123.54,0.00,'00010001000000000034501',3,'2022-04-30 11:56:32');
