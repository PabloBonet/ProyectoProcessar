...
INSERT INTO `otordentra` (`idpedido`,`idot`,`fechaot`,`fechaini`,`testimado`,`costoest`,`descriptot`,`idestado`,`detaestado`,`responsa`,`observa`,`idetapa`,`etapa`) VALUES 
 ...
 (6,8,'20180409','20180409','20d-  :  :',15000.00,'AMOBLAMIENTO LIVING',3,'FINALIZADO','FEDE','',8,'TRANSPORTE Y COLOCACIÓN'),
 (6,9,'20180409','20180409','15d-  :  :',10000.00,'OT COCINA',3,'FINALIZADO','FEDE','',5,'ARMADO Y CONTROL DE CALIDAD'),
