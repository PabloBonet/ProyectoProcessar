...
INSERT INTO `esquemas` (`idesquema`,`descrip`,`schemma`,`driver`,`host`,`port`,`usuario`,`password`,`fondo`,`colorfondo`,`habilitado`,`idempresa`,`idsucursal`,`path`) VALUES 
 ...
 (1,'1_TrSoft_Casa','trsoftdb','{MySQL ODBC 3.51 Driver}','tuly.changeip.org','3306','tulior','owntod93','','8454143','S',0,0,''),
 (2,'2_TRSoft_Alsafex','trsoftdb','{MySQL ODBC 3.51 Driver}','alsafex.changeip.org','3306','tulior','owntod93','','8454143','S',0,0,''),
 (3,'TRSoft-IT','trsoftdb','{MySQL ODBC 3.51 Driver}','debian','3306','tulior','owntod93','','8454143','S',0,0,''),
...
CREATE TABLE `iconos` (
  ...
  `teclafn` char(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`idicono`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `iconos` (`idicono`,`nombre`,`archivo`,`tooltip`,`teclafn`) VALUES 
 ...
 (11,'conjunto','intervalo.png','Conjunto-Intervalo',''),
 (12,'garante','aprobado.png','Garantías - Garantes',''),
 (13,'gruposepe','grupo.png','Grupo Sepelio','');
...
INSERT INTO `articulos` (`articulo`,`detalle`,`unidad`,`abrevia`,`codbarra`,`costo`,`linea`) VALUES 
 ('000001','CAJA VINO TINTO TORO','LITROS','VINO','3333333333',100.0000,'01'),
 ('000002','PORRON SANTA FE','LITROS','PORRON','6666666666',150.0000,'01'),
 ('000003','HARINA','KILOS','HARINA','AAAAAAAAAA',50.0000,'01');
...
CREATE TABLE `conceptolimit` (
  ...
  `idconcelim` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`idconcelim`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `conceptolimit` (`idconcepto`,`servicio`,`concepto`,`consudesde`,`consuhasta`,`unidad`,`detalle`,`importe`,`idconcelim`) VALUES 
 (2,2,'ESP',200.0000,300.0000,'ESPO','LIMITE DOS',300.00,1),
 (2,2,'ESP',200.0000,400.0000,'ESPO','LIMTE TRES',150.00,2),
 (2,2,'ESP',600.0000,700.0000,'ESPO','LIMTE CUATRO ss',700.00,3);
...
INSERT INTO `conceptoser` (`idconcepto`,`servicio`,`concepto`,`detalle`,`abrevia`,`cantidad`,`importe`,`unidad`,`facturar`,`cuotasfact`,`cantcuotas`,`funcion`,`vigedesde`,`vigehasta`,`vigencia`,`padron`,`compuesto`) VALUES 
 (1,2,'PUB','PUBLICIDAD','PUB',1.0000,100.0000,'U','S',0,0,'calculopublicidad','20160718','20160718','1',1,'N'),
 (2,2,'ESP','ESPACIO','ESP',2.0000,150.0000,'ESPO','S',0,0,'','20160718','20160620','2',10,'N');
...
INSERT INTO `entidadesg` (`idgarante`,`entidad`,`apellido`,`nombre`,`cargo`,`sector`,`direccion`,`localidad`,`fechaalta`,`telefono`,`cp`,`fax`,`email`,`dni`,`tipodoc`,`fechanac`,`cuit`) VALUES 
 (1,1,'LORENA','CHIA','','','AVELLANEDA 6737','3','20160725','','3000','','',20662027,'1','19720210','2320');
...
INSERT INTO `menusql` (`idmenu`,`idmenup`,`nivel`,`codigo`,`descrip`,`arranque`,`comando`,`opcion`,`prun`,`pusu`,`habilitado`,`orden`,`usuario`,`fechahora`,`idmodulo`,`imagen`) VALUES 
 ...
 (12,1,'H','01250000000000','\\-','','','','N','N','S','05','admin','2016030610:51:06',1,''),
 (13,1,'H','01260000000000','Salir                               Alt+F4','','SALIRMENU()','','S','S','S','01','admin','2016062420:45:28',1,'CERRAR.PNG'),
 ...
 (17,1,'H','01230000000000','Iconos','','DO FORM iconosabm','7','S','S','S','01','admin','2016062510:05:54',1,'FACE03.ICO'),
 (18,1,'H','01210000000000','Biblioteca de Función','','DO FORM bibliotecafabm','8','S','S','S','01','admin','2016052021:15:00',1,''),
 (19,1,'H','01040000000000','Sucursales','','DO FORM sucursalesabm','9','S','S','S','01','admin','2016052115:24:00',1,''),
 (20,1,'H','01220000000000','Modulos del Sistema','','DO FORM modulossysabm','10','S','S','S','01','admin','2016052116:38:00',1,''),
 ...
 (25,1,'H','01180000000000','Lineas','','DO FORM lineasabm','15','S','S','S','01','admin','2016061117:14:00',1,''),
 ...
 (28,1,'H','01200000000000','\\-','','','','S','S','S','01','admin','2016062511:00:16',1,''),
 (29,1,'H','01240000000000','Seteo ToolBar Sys','','DO FORM toolbarsysabm','','S','S','S','01','admin','2016062601:40:20',1,''),
 (30,1,'H','01060000000000','Clientes-Proveedores','','DO FORM entidades','','S','S','S','01','admin','2016062900:05:11',1,'EMPLY.ICO'),
 (31,1,'H','01170000000000','Artículos','','DO FORM articulos','','S','S','S','01','admin','2016070212:00:11',1,'WZPRINT.BMP'),
 ...
 (34,1,'H','01190000000000','Conceptos Servicios','','DO FORM conceptoser','','S','S','S','01','admin','2016071510:54:24',1,'');
