...
INSERT INTO `ajustestockh` (`idajuste`,`articulo`,`detalle`,`idtipomov`,`descmov`,`ie`,`cantidad`,`idajusteh`,`renglon`) VALUES 
 (1,'0000000003','GASEOSA COCA-COLA 6 X 1.5L',1,'ENTREGA MATERIALES POR PEDIDO DE CLIENTE','E',1.0000,1,1),
 (1,'0000000002','VINO TORO 12 X 1L',1,'ENTREGA MATERIALES POR PEDIDO DE CLIENTE','E',1.0000,2,1),
 (2,'0000000001','HARINA',2,'INGRESO DE ARTICULOS AL STOCK POR COMPRA DE MERCADERIA','I',3.0000,3,1),
 (2,'0000000003','GASEOSA COCA-COLA 6 X 1.5L',2,'INGRESO DE ARTICULOS AL STOCK POR COMPRA DE MERCADERIA','I',2.0000,4,1),
 (3,'0000000003','GASEOSA COCA-COLA 6 X 1.5L',1,'ENTREGA MATERIALES POR PEDIDO DE CLIENTE','E',1.0000,5,1),
 (3,'0000000002','VINO TORO 12 X 1L',1,'ENTREGA MATERIALES POR PEDIDO DE CLIENTE','E',3.0000,6,1);
...
INSERT INTO `ajustestockp` (`idajuste`,`actividad`,`numero`,`fecha`,`entidad`,`nombre`,`responsable`,`observa1`,`observa2`,`observa3`,`observa4`,`anulado`,`idtipomov`,`descmov`,`deposito`,`descdepo`) VALUES 
 (1,1,1,'20161220',1,'ROSSI TULIO','FEDE','','','','','N',1,'ENTREGA MATERIALES POR PEDIDO DE CLIENTE',1,'DEPOSITO 1'),
 (2,1,2,'20161220',3,'OLIVIERO GERMAN','FEDE','','','','','N',2,'INGRESO DE ARTICULOS AL STOCK POR COMPRA DE MERCADERIA',2,'DEPOSITO 2'),
 (3,1,3,'20161220',1,'ROSSI TULIO','FEDE','','','','','N',1,'ENTREGA MATERIALES POR PEDIDO DE CLIENTE',1,'DEPOSITO 1');
...
INSERT INTO `articulos` (`articulo`,`detalle`,`unidad`,`abrevia`,`codbarra`,`costo`,`linea`) VALUES 
 ...
 ('0000000002','VINO TORO 12 X 1L','LITROS','VINO TORO EN CAJA','11111111',145.3300,'01'),
 ('0000000003','GASEOSA COCA-COLA 6 X 1.5L','LITROS','COCA DE LITRO Y MEDIO','222222',114.7800,'01');
...
CREATE TABLE `compactiv` (
  ...
  `puntov` int(10) unsigned NOT NULL,
...
INSERT INTO `menusql` (`idmenu`,`idmenup`,`nivel`,`codigo`,`descrip`,`arranque`,`comando`,`opcion`,`prun`,`pusu`,`habilitado`,`orden`,`usuario`,`fechahora`,`idmodulo`,`imagen`) VALUES 
 ...
 (12,1,'H','01290000000000','\\-','','','','N','N','S','05','admin','2016030610:51:06',1,''),
 (13,1,'H','01300000000000','Salir                               Alt+F4','','SALIRMENU()','','S','S','S','01','admin','2016062420:45:28',1,'CERRAR.PNG'),
 ...
 (17,1,'H','01270000000000','Iconos','','DO FORM iconosabm','7','S','S','S','01','admin','2016062510:05:54',1,'FACE03.ICO'),
 (18,1,'H','01250000000000','Biblioteca de Función','','DO FORM bibliotecafabm','8','S','S','S','01','admin','2016052021:15:00',1,''),
 (19,1,'H','01040000000000','Sucursales','','DO FORM sucursalesabm','9','S','S','S','01','admin','2016052115:24:00',1,''),
 (20,1,'H','01260000000000','Modulos del Sistema','','DO FORM modulossysabm','10','S','S','S','01','admin','2016052116:38:00',1,''),
 ...
 (28,1,'H','01240000000000','\\-','','','','S','S','S','01','admin','2016062511:00:16',1,''),
 (29,1,'H','01280000000000','Seteo ToolBar Sys','','DO FORM toolbarsysabm','','S','S','S','01','admin','2016062601:40:20',1,''),
 ...
 (38,1,'H','01230000000000','Tipos de Comprobantes','','DO FORM tipocompro','','S','S','S','01','admin','2016122113:56:00',1,'');
...
INSERT INTO `tipocompro` (`idtipocom`,`detalle`,`opera`,`abrevia`,`destino`,`editable`) VALUES 
 (1,'FACTURA A',1,'FA','S','N'),
 (2,'NOTA DE PEDIDO',-1,'NP','S','S');
