...
sqlmatriz(3)="where h.idperfil = "+ALLTRIM(STR(tnId))+" and h.habilitado = 'S' and m.habilitado = 'S' and u.activo = 1 and m.idmodulo = 1 group by h.idmenu order by m.orden, m.codigo"
...
*!*	      \ENDIF
      ...
      \DEFINE MENU (m.cMenuName) IN SCREEN BAR
      \*
      ****************
*!*	 	  LOCAL oFormRef, getMenuName 
 	  
*!*	      IF TYPE("m.getMenuName")="L" AND m.getMenuName
*!*		         m.oFormRef.Name = m.cMenuName
*!*	      ENDIF
      *DEFINE MENU (m.cMenuName) IN screen  BAR
*!*	      MESSAGEBOX(" 1 "+m.cMenuName)
